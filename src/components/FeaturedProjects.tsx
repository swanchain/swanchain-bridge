...
const dummyProjects: Project[] = [
    {
        name: 'Gas.zip',
        description: 'Fastest one-stop gas refuel bridge for over 350+ chains. Bridge and explore all your favorite alt-chains and L2s, instantly.',
        url: 'https://www.gas.zip/',
        icon: '/assets/images/gas.png',
    },
    {
        name: 'IceCreamSwap',
        description: 'IceCreamSwap offers DEX functions such as Swap, Liquidity, Farm, Staking, Bridge, Info, and Launchpad.',
        url: 'https://icecreamswap.com/',
        icon: '/assets/images/icecreamswap.png',
    },
    {
        name: 'SwanFi',
        description: 'A next-generation staking platform designed to empower Swan Chain.',
        url: 'https://stake.swanfi.xyz/',
        icon: '/assets/images/swanfi.png',
    },
    {
        name: 'Parasail',
        description: 'Earn DePIN Rewards. Delegate and stake your token assets to secure services of DePIN networks and earn rewards.',
        url: 'https://www.parasail.network/delegate/swan',
        icon: '/assets/images/parasail.png',
    },
]
...
const FeaturedProjects: React.FC = () => {
    ...
    return (
        <div className="featured-projects">
            <div className="title">Featured projects on Swan Chain</div>
            ...
            <div className="content">
                {projects.map((project, index) => (
                    <div
                        ...
                        className={`featured-projects-card ${project.url ? 'pointer' : 'is-disabled'
                            }`}
                    >
